  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-0.5">Here's what's happening with your social accounts today.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        ...
        {activities.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-6">
            <div className="size-12 bg-slate-100 rounded-xl flex items-center justify-center mb-3"><ActivityIcon className="size-6 text-slate-400" /></div>
